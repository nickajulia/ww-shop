...
if (document.querySelector('.product-tabs')) {
  new _components_product_tab__WEBPACK_IMPORTED_MODULE_1__.ProductTab();
}
...
var menus = document.querySelectorAll('.header__inline-menu .mega-menu');
...
/***/ "./src/js/components/product-image-description.js":
/*!********************************************************!*\
  !*** ./src/js/components/product-image-description.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "ProductImageDescription": () => (/* binding */ ProductImageDescription)
/* harmony export */ });
...
var ProductImageDescription = /*#__PURE__*/function () {
  function ProductImageDescription() {
    _classCallCheck(this, ProductImageDescription);
  ...
  _createClass(ProductImageDescription, [{
    key: "renderDescriptionImage",
    value: function renderDescriptionImage() {
      var imageDesktop = document.querySelector(this.selector.desktopImgSelector);
      var imageDesktopSrc = imageDesktop.getAttribute('src');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ProductTab": () => (/* binding */ ProductTab)
/* harmony export */ });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ProductTab = /*#__PURE__*/function () {
  function ProductTab() {
    ...
    document.querySelectorAll(this.classes.tabsLink).forEach(function (element) {
      element.addEventListener('click', _this.selectTabActive.bind(_this));
    });
    ;
  }
  ...
  _createClass(ProductTab, [{
    key: "selectTabActive",
    value: function selectTabActive(e) {
      e.preventDefault();
      var scroll = e.target.getAttribute('data-scroll'),
          scroll_to = e.target.getAttribute('data-scroll-element'); // make tab active  

      this.seTabActive(e.target);

      if (!scroll) {
        this.removeActiveTabContent();
        document.querySelector("#content-".concat(e.target.id)).classList.add('active');
      }
    }
  }, {
    key: "removeActiveTabContent",
    value: function removeActiveTabContent() {
      document.querySelectorAll(this.classes.tabContent).forEach(function (element) {
        element.classList.remove('active');
      });
    }
  }, {
    key: "seTabActive",
    value: function seTabActive(target) {
      document.querySelectorAll(this.classes.tabsLink).forEach(function (element) {
        element.classList.remove('active');
      });
...
/***/ "./src/js/components/product-testimonial.js":
/*!**************************************************!*\
  !*** ./src/js/components/product-testimonial.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ProductTestimonial": () => (/* binding */ ProductTestimonial)
/* harmony export */ });
/* harmony import */ var flickity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! flickity */ "./node_modules/flickity/js/index.js");
/* harmony import */ var flickity__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(flickity__WEBPACK_IMPORTED_MODULE_0__);


var ProductTestimonial = function ProductTestimonial() {
  var breakpoint = window.matchMedia('(min-width: 990px)');

  if (breakpoint.matches === false) {
    var elem = document.querySelector('.testimonials-outer-wrap');
    new (flickity__WEBPACK_IMPORTED_MODULE_0___default())(elem, {
      // options
      freeScroll: true,
      contain: true,
      pageDots: true,
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkww_shop"] = self["webpackChunkww_shop"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["assets/theme"], () => (__webpack_require__("./src/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/theme"], () => (__webpack_require__("./src/scss/theme.scss")))
